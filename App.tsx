    ...
    switch (appState.currentScreen) {
      ...
      case 'dashboard':
        if (appState.userRole === 'patient') {
          ...
          return <DoctorDashboard onNavigate={navigateTo} userProfile={appState.userProfile} />;
        } else if (appState.userRole === 'admin') {
          return <AdminDashboard onNavigate={navigateTo} userProfile={appState.userProfile} />;
        }
        break;
      case 'clinic-locator':
        return (
  ...
  return (
    <TranslationProvider>
      <div className="min-h-screen bg-gray-50">
        ...
        {/* Top Navigation Bar */}
        {appState.isLoggedIn && appState.currentScreen !== 'splash' && appState.currentScreen !== 'login' && appState.currentScreen !== 'register' && (
          <div className="fixed top-0 left-0 right-0 glass-nav z-40 p-4">
